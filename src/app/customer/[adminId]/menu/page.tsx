          ...
          <AnimatePresence>
            {filteredItems.map((item) => (
              <motion.div
                ...
                className={`group relative bg-card border border-white/5 rounded-[2rem] overflow-hidden hover:border-primary/30 transition-all ${
                ...
                <div className="aspect-[4/3] overflow-hidden relative">
                  ...
                  {!item.isAvailable && (
                    <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                      <span className="bg-red-500 text-white text-[10px] font-black uppercase tracking-widest px-4 py-1 rounded-full">Sold Out</span>
                    </div>
                  )}
                </div>
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-2">
                    {getItemQuantity(item._id) > 0 ? (
                      <div className="flex items-center justify-between bg-primary/10 rounded-2xl p-1 border border-primary/20">
                        <Button
                          variant="ghost"
                          size="icon"
                        ...
                        <span className="font-black text-primary">{getItemQuantity(item._id)}</span>
                        <Button
                          variant="ghost"
                          size="icon"
                      ...
                      <Button
                        className="w-full h-12 rounded-2xl font-black uppercase tracking-widest gap-2 shadow-lg shadow-primary/10"
                        onClick={(e) => { e.stopPropagation(); addToCart(item._id); }}
